...
with open("thenewpoketext/batch.cmd", "w"): pass
...
for file_name in os.listdir(folder_path):
    if file_name.endswith(".nds"):
        ...
        script_file_name = f"script_{file_name_no_ext}.txt"
        ...
        with open("thenewpoketext/batch.cmd", "a") as batch_file:
            batch_file.write(f"thenewpoketext < {script_file_name}\n")

# Add the "@echo off" line to the batch file
with open("thenewpoketext/batch.cmd", "r") as batch_file:
    lines = batch_file.readlines()

with open("thenewpoketext/batch.cmd", "w") as batch_file:
